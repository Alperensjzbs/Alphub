...
ImageButton.Image = "http://www.roblox.com/asset/?id=17824828704"
...
local listfastattack = {'Normal','Slow','Super','Low'}
    ...
    _G.FastAttackDamthien_Mode = Value
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    local ToggleTerrorshark = Tabs.Sea:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark 20%",Description = "", Default = false })
...
if Third_Sea then
	...
	spawn(function()
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Get Tushita",Description = "", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Auto Kill Dought King (Need Spawn)",Description = "", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Auto Buy Haki Color",Description = "",Default = false })
...
local StatusBone = Tabs.Status:AddParagraph({
    Title = "Check Bone",
    Content = ""
})
	spawn(function()
...
Options.ToggleAutoSoulGuitar:SetValue(false)
spawn(function()
		while wait() do
			pcall(function()
...
Tabs.profile:AddParagraph({
        Title = "link Discord Byte Hub",
        Content = "https://discord.gg/PF36rvJXN4"
    })      
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop
...
if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Server Hop Full Moon",Description = "", Default = false })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Server Hop Mirage Island",Description = "", Default = false })
